...
-- -----------------------------------------------------
-- Table `techpassdb`.`cartao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpassdb`.`cartao` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `techpassdb`.`cliente_tem_cartao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpassdb`.`cliente_tem_cartao` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_clliente_tem_cartao_cartao1`
    ...
    REFERENCES `techpassdb`.`cartao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `techpassdb`.`rotas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpassdb`.`rotas` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `percurso` INT NULL,
...
-- -----------------------------------------------------
-- Table `techpassdb`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpassdb`.`usuario` (
  `clientes_id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `techpassdb`.`viagem` (
  ...
  CONSTRAINT `fk_viagem_motorista1`
    ...
    REFERENCES `techpassdb`.`motorista` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `techpassdb`.`embarque` (
  ...
  CONSTRAINT `fk_embarque_clliente_tem_cartao1`
    ...
    REFERENCES `techpassdb`.`cliente_tem_cartao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
