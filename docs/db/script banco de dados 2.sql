...
-- -----------------------------------------------------
-- Table `techpass`.`cliente_tem_cartao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpass`.`cliente_tem_cartao` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `techpass`.`ponto_de_onibus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpass`.`ponto_de_onibus` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `endereco` VARCHAR(255) NULL,
  `cep` VARCHAR(9) NULL,
  `lat` DECIMAL(9,6) NULL,
...
CREATE TABLE IF NOT EXISTS `techpass`.`rotas` (
  ...
  CONSTRAINT `fk_rotas_pontoOnibus1`
    ...
    REFERENCES `techpass`.`ponto_de_onibus` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `techpass`.`embarque` (
  ...
  CONSTRAINT `fk_embarque_clliente_tem_cartao1`
    ...
    REFERENCES `techpass`.`cliente_tem_cartao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `techpass`.`horario_diario_saida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `techpass`.`horario_diario_saida` (
