...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `techpassdb` /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `atendente` (
    `superUser_id` int unsigned NOT NULL AUTO_INCREMENT,
    `local_de_trabalho_id` int DEFAULT NULL,
    `turno` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `cartoes_do_cliente` (
    ...
    `codigo_do_cartao` int DEFAULT NULL,
...
CREATE TABLE `embarque` (
    `id` int NOT NULL AUTO_INCREMENT,
    `cartaoDoCliente_id` int DEFAULT NULL,
...
CREATE TABLE `horario_diario_saida` (
    ...
    `duracaoEstimada` int DEFAULT NULL,
    PRIMARY KEY (`id`),
...
CREATE TABLE `linhas` (
    ...
    `bairroOrigem` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
    `bairroDestino` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
    PRIMARY KEY (`id`)
...
CREATE TABLE `loja_recarga` (
    `id` int NOT NULL AUTO_INCREMENT,
    `nome` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT 'Tech Pass',
...
VALUES (
        ...
        'primeria',
        '116652-85',
        'Avenida Brasília, Indaiá, Caraguatatuba, SP',
        -23.631863,
        -45.431446
    ),
    (
        ...
        'segunda',
        '078500-40',
        'Rua Ruy Barbosa, Vila Zanela, Franco da Rocha, SP',
        -23.330564,
        -46.723167
    ),
    (
        ...
        'terceira',
        '116633-40',
        'Rua Sebastião Carneiro, Jardim Olaria, Caraguatatuba, SP',
        -23.606752,
        -45.375374
    );
...
CREATE TABLE `motorista` (
    ...
    `cnh` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    PRIMARY KEY (`superUser_id`),
...
CREATE TABLE `onibus` (
    ...
    `quantidade_passageiros` int DEFAULT NULL,
    `estado_atual` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    `possui_acessibilidade` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    PRIMARY KEY (`id`)
...
CREATE TABLE `percurso` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `ordem_do_percurso` int DEFAULT NULL,
    `linha_id` int unsigned NOT NULL,
    `pontoOnibus_id` int NOT NULL,
    PRIMARY KEY (`id`),
...
CREATE TABLE `tipos_de_cartao` (
    `id` int NOT NULL AUTO_INCREMENT,
    `modalidade` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
    `tarifa` decimal(6, 2) DEFAULT NULL,
    `tipos_de_cartaocol` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
    PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 4 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */
;
...
CREATE TABLE `viagem` (
    ...
    `linhas_id` int unsigned DEFAULT NULL,
    `onibus_id` int DEFAULT NULL,
    `motorista_SU_id` int unsigned DEFAULT NULL,
    PRIMARY KEY (`id`),
...
-- Dump completed on 2024-11-19 17:51:58